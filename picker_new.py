...
for file in glob.glob("*.txt"):
    ...
    #for p in onofftime:
    import csv
    with open('earthquake_mytry3.csv', 'a') as csvfile:
        while i < len(onofftime):
            ...
            try:
                ...
                p_pick, s_pick = ar_pick(tr_bhz[0].data, tr_bhn[0].data, tr_bhe[0].data, df,1.0, 20.0, 1.0, 0.1, 4.0, 1.0, 2, 8, 0.1, 0.2,True)
