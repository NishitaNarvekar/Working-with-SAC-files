...
import csv
with open('/Users/Nishita/Documents/Research/testing/trainnoearth_max_amp_allstation.csv', 'a') as csvfile:
...
for file in glob.glob("*XX.*JJS*"):
    ...
    with open('/Users/Nishita/Documents/Research/testing/trainnoearth_max_amp_allstation.csv', 'a') as csvfile:
        ...
        for i in range(1,30):
            tr_bhz = read(file)
            tr_bhz1 = read(file,starttime=tr_bhz[0].stats.starttime+min1,endtime=tr_bhz[0].stats.starttime+max1,debug_headers=True)
            tr = tr_bhz1[0].data
            ...
            spamwriter = csv.writer(csvfile, delimiter=',')
                    ...
                    #row = zip(*l)
            spamwriter.writerow([tr_bhz1[0].stats.station, tr_bhz1[0].stats.channel,tr_bhz1[0].stats.starttime.timestamp,tr_bhz1[0].stats.endtime.timestamp,tr_bhz1[0].stats.npts,tr_bhz1[0].stats.sac.e,tr_max,tr_std,0,BHZdata,BHZdata2,BHZdata3,BHZdata4,BHZdata5,BHZdata6,BHZdata7,BHZdata8])
            count=count+1;
