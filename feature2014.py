...
import csv
with open('/Users/Nishita/Documents/Research/testing/feature_earthquake.csv', 'a') as csvfile:
...
for file in glob.glob("*SC.*JJS*"):
    ...
    starttime1=st[0].stats.starttime
